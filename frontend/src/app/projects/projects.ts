...
import {
  TaskDetailModal,
  TaskData,
  ActivityEntry as TaskActivityEntry
} from './task-detail-modal/task-detail-modal.component';
...
@Component({
  ...
  // IMPORTANT:
  // ErpPage has been added here so <app-erp-page>
  // can be used inside projects.html.
  imports: [
    FormsModule,
    TaskDetailModal,
    ErpPage
...
export class Projects implements OnInit {
  ...
  readonly priorities: ProjectRecord['priority'][] = [
    'High',
    'Medium',
    'Low'
  ];
  ...
  projects: ProjectRecord[] = [
...

    {
      ...
      description:
        'The internal people operations workspace.',
      ...
      tasks: [

        {
          ...
          description:
            'Design the database schema for the ERP system.',
...

        {
          ...
          description:
            'Build the employee module with CRUD operations.',
...

        {
          ...
          title: 'Build leave management module',

          done: false,

          assignedTo: 'Neel Desai',
...

        {
          ...
          description:
            'Set up role-based access control for the system.',
      ...
      activity: [
        {
          id: 'a3',
          text: 'Completed task: Build employee module',
          date: 'Apr 10, 2025'
        },

        {
          id: 'a2',
          text: 'Completed task: Design database schema',
          date: 'Feb 02, 2025'
        },
...

    {
      ...
      description:
        'A clearer way for clients to follow delivery.',
      ...
      tasks: [
...

        {
          ...
          description:
            'Design UI mockups for the client portal.',
...

        {
          ...
          description:
            'Build the authentication flow for the client portal.',
      ...
      activity: [
        {
          id: 'a2',
          text: 'Completed task: Gather client requirements',
          date: 'Apr 18, 2025'
        },
  ...
  ngOnInit(): void {
    ...
    if (saved) {
      ...
      const parsed =
        JSON.parse(saved) as Partial<ProjectRecord>[];
  ...
  addProject(): void {
    ...
    this.projects.push({
      ...
      description:
        'A new project for the Synaptech team.',
  ...
  get taskProgressLocked(): boolean {
  ...
  toggleTask(
    ...
    this.logProjectActivity(
      project,
      `${task.done ? 'Completed' : 'Reopened'} task: ${task.title}`
    );
